...
public class PrintTree  {
   public static void pirnt(myBinarySearchTree.Node root) {
      // 找到左边的最大偏移量
   ...
   private static void calculateLines(myBinarySearchTree.Node parent, int offset, Map<Integer, PrintLine> lineMap, int level,
                                      boolean right) {
      if (parent == null) {
         return;
      }
      ...
      if (parent.getLeftNode() != null) {
         ...
         calculateLines(parent.getLeftNode(), offset - nameoffset - 1, lineMap, level + 2, false);
      }
      if (parent.getRightNode() != null) {
         separateLine.putString(offset + nameoffset + 1, "\\");
         calculateLines(parent.getRightNode(), offset + nameoffset + 1, lineMap, level + 2, true);
      }
   ...
   private static int findMaxOffset(myBinarySearchTree.Node parent, int offset, boolean findLeft) {
      if (parent != null) {
         offset += parent.toString().length();
      }
      if (findLeft && parent.getLeftNode() != null) {
         offset += 1;
         return findMaxOffset(parent.getLeftNode(), offset, findLeft);
      }
      if (!findLeft && parent.getRightNode() != null) {
         return findMaxOffset(parent.getRightNode(), offset, findLeft);
      }
      return offset;
   }
}
